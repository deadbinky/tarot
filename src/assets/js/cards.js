  ...
  thefool: {
    ...
    description: {
      upright: {
        ...
        text: 'The Fool begins the story of the major arcana.  Their number is zero, which can represent being at the beginning of something, or it can represent wholeness and infinity.  The Fool is one with the Universe as they set out on their happy adventure. Here, they are depicted as a foal filled with boundless excitement.  They leap into the unknown with no baggage to weigh them down.'
      },
      reversed: {
        keywords: ['reckless', 'naive', 'leaping before you look'],
        text: 'In reverse, the Fool can represent foolishness and lack of planning.  They can warn of the current action or mindset being reckless.  Stop for a moment and make sure you\'ve really considered the fallout of whatever move you\'re making.  If you read reversals as blocked energy, the Fool can represent resisting starting something.'
      }
    }
  },
  themagician: {
    ...
    description: {
      upright: {
        ...
        text: 'The Magician is one with the Universe, as represented by the infinity sign over their head. They can harness the energies of the Universe to manifest whatever they imagine into being.  The Magician can represent artists, makers, and creators of all kinds.  They can also represent the intense willpower needed to start or stop a habit or activity.'
      },
      reversed: {
        keywords: ['lack of energy', 'creative block', 'trickery'],
        text:  'In reverse, the Magician can represent a creative block, an inability to manifest your desires, or simply, a lack of willpower or energy. In their most devious form, this card can even represent a trickster who uses manipulation, illusion and lies to attain their goals.'
      }
    }
  },
  thehighpriestess: {
  ...
  thehierophant: {
    ...
    description: {
      upright: {
        ...
        text: 'The Hierophant is the revealer of sacred things.  This card is the inner teacher of divine secrets and can help to reveal our deep ties to the Universe, whether that takes the form of traditional religion, or something more spiritual.  The Hierophant unlocks the divine secret that there is more to existence than what we detect with our senses.  They can also represent society, conformity, and traditional values'
      },
      reversed:  {
